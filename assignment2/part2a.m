...
quiver(w1_init, w2_init, 0.25*g(1), 0.25*g(2), 'AutoScale','off', 'Color', 'r')
...
quiver(w1_new, w2_new, n*h(1), n*h(2), 'AutoScale','off', 'Color', 'b')
quiver(w1_new, w2_new, g(1), g(2), 'AutoScale','off', 'Color', 'r')
